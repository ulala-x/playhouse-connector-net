...
namespace PlayHouseConnector.network.buffer
{
    ...
    public class DynamicBuffer : IDisposable
    {
        ...
        public static void Init(long maxBufferPoolSize = 1024*1024*10)
        {
        ...
        /// </summary>
        public DynamicBuffer(byte[] data) { _data = data; _size = data.Length; _offset = 0; }
        ...
        /// <param name="buffer">Buffer to append</param>
        /// <returns>Count of append bytes</returns>
        public long Append(DynamicBuffer buffer) => Append(buffer.AsSpan());
